  ...
  <Teleport to="body">
    <Transition name="lightbox">
      ...
      >
        ...
        <button
          v-if="currentImage"
          class="absolute right-16 top-4 z-10 rounded-full bg-white/10 p-2 text-white hover:bg-white/20 transition-colors"
        ...
        <button
          ...
          class="absolute left-4 top-1/2 -translate-y-1/2 z-10 rounded-full bg-white/10 p-3 text-white hover:bg-white/20 transition-colors disabled:opacity-30"
        ...
        <button
          v-if="images.length > 1"
          class="absolute right-4 top-1/2 -translate-y-1/2 z-10 rounded-full bg-white/10 p-3 text-white hover:bg-white/20 transition-colors disabled:opacity-30"
        ...
        <!-- Counter & revised prompt -->
        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 text-center">
          <p v-if="images.length > 1" class="mb-2 text-sm text-white/70">
            {{ currentIndex + 1 }} / {{ images.length }}
          </p>
          <p
            v-if="currentImage?.revised_prompt"
            class="max-w-xl rounded-lg bg-black/50 px-4 py-2 text-sm text-white/90 backdrop-blur-sm"
          >
