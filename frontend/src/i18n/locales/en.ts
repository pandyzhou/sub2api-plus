export default {
  ...
  nav: {
    ...
    accounts: 'Accounts',
    proxies: 'Proxies',
    chatgptGroup: 'ChatGPT Tools',
    chatgptAccounts: 'ChatGPT Accounts',
    chatgptRegister: 'ChatGPT Register',
  ...
  image: {
    ...
    promptPlaceholder: 'e.g. A cat floating in space, cyberpunk style...',
    model: 'Model',
    size: 'Size',
    quality: 'Quality',
    count: 'Count',
    ...
    noImages: 'No images yet. Enter a prompt to start creating',
    noSessions: 'No sessions yet',
    deleteSession: 'Delete',
    confirmClear: 'Are you sure you want to clear all history?',
    confirmDelete: 'Are you sure you want to delete this session?',
    sessionDeleted: 'Session deleted',
    sessionsCleared: 'History cleared',
  ...
  chatgpt: {
    connection: {
      ...
      save: 'Save & Connect',
      connected: 'Connected',
      notConfigured: 'chatgpt2api connection not configured',
    },
    accounts: {
      title: 'ChatGPT Account Management',
      subtitle: 'Manage ChatGPT access token account pool for image generation',
      refreshAll: 'Refresh All',
      import: 'Import',
      search: 'Search email/token...',
      allStatus: 'All Status',
      statusNormal: 'Normal',
      ...
      statusDisabled: 'Disabled',
      statsTotal: 'Total',
      statsQuota: 'Quota Left',
      selectedCount: '{n} selected',
      refreshSelected: 'Refresh ({n})',
      exportSelected: 'Export ({n})',
      ...
      colActions: 'Actions',
      empty: 'No accounts',
      errorLoading: 'Failed to load, check connection settings',
      importTitle: 'Import ChatGPT Accounts',
      importPlaceholder: 'One access_token per line, or paste JSON (session/CPA format)',
      doImport: 'Import',
      editTitle: 'Edit Account',
      exportTitle: 'Export Accounts',
      doExport: 'Download',
      deleteConfirmTitle: 'Confirm Delete',
      deleteConfirmMsg: 'Are you sure you want to delete {n} selected accounts? This cannot be undone.',
    },
    register: {
      title: 'ChatGPT Registration Machine',
      subtitle: 'Automated ChatGPT account registration',
      saveConfig: 'Save Config',
      start: 'Start',
      stop: 'Stop',
      ...
      statStatus: 'Status',
      progress: 'Progress',
      configTitle: 'Registration Config',
      logsTitle: 'Logs',
      noLogs: 'No logs',
      fieldMode: 'Mode',
      modeTotal: 'By Count',
      modeQuota: 'By Quota',
      modeAvailable: 'By Available',
      fieldTotal: 'Total Count',
      fieldThreads: 'Threads',
      fieldProxy: 'Proxy URL',
      fieldTargetQuota: 'Target Quota',
      fieldTargetAvailable: 'Target Available',
      fieldCheckInterval: 'Check Interval (s)',
    },
  },
