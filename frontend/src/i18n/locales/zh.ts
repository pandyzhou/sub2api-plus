export default {
  ...
  nav: {
    ...
    accounts: '账号管理',
    proxies: 'IP管理',
    chatgptGroup: 'ChatGPT 工具',
    chatgptAccounts: 'ChatGPT 账号',
    chatgptRegister: 'ChatGPT 注册机',
    redeemCodes: '兑换码',
    ops: '运维监控',
    promoCodes: '优惠码',
    settings: '系统设置',
  ...
  image: {
    ...
    imageEdit: '图片编辑',
    prompt: '描述你想要生成的图片',
    promptPlaceholder: '例如：一只漂浮在太空里的猫，赛博朋克风格...',
    model: '模型',
    size: '尺寸',
    quality: '质量',
    count: '生成数量',
    ...
    download: '下载',
    downloadAll: '全部下载',
    noImages: '还没有生成图片，输入提示词开始创作吧',
    noSessions: '暂无会话记录',
    deleteSession: '删除',
    confirmClear: '确认清空所有历史记录？',
    confirmDelete: '确认删除这个会话？',
    sessionDeleted: '会话已删除',
    sessionsCleared: '历史已清空',
    generateFailed: '生成失败',
    editFailed: '编辑失败',
  },
  ...
  chatgpt: {
    connection: {
      ...
      save: '保存并连接',
      connected: '已连接',
      notConfigured: '未配置 chatgpt2api 连接',
    },
    accounts: {
      title: 'ChatGPT 账号管理',
      subtitle: '管理用于图片生成的 ChatGPT access token 账号池',
      refreshAll: '刷新全部',
      import: '导入账号',
      search: '搜索邮箱/Token...',
      allStatus: '全部状态',
      ...
      colActions: '操作',
      empty: '暂无账号',
      errorLoading: '加载失败，请检查连接配置',
      importTitle: '导入 ChatGPT 账号',
      importPlaceholder: '每行一个 access_token，或粘贴 JSON (session/CPA格式)',
      doImport: '导入',
      editTitle: '编辑账号',
      exportTitle: '导出账号',
      doExport: '下载',
      deleteConfirmTitle: '确认删除',
      deleteConfirmMsg: '确定要删除 {n} 个选中的账号吗？此操作不可撤销。',
    },
    register: {
      title: 'ChatGPT 注册机',
      subtitle: '自动化注册 ChatGPT 账号',
      saveConfig: '保存配置',
      start: '启动注册',
      stop: '停止注册',
      resetStats: '重置统计',
      ...
      fieldThreads: '线程数',
      fieldProxy: '代理地址',
      fieldTargetQuota: '目标额度',
      fieldTargetAvailable: '目标可用数',
      fieldCheckInterval: '检查间隔(秒)',
    },
  },
